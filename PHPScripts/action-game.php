...
// Database connection
require("dbinit.php");
$sqlNinthToFourteenth = "SELECT * FROM games LIMIT 14, 6"; // Starting from the 9th record, fetch 6 records
          ...
          <ul class="navbar-nav mb-2 mb-lg-0 d-flex align-items-center">
            ...
            <form class="d-flex mx-4" role="search" method="GET" action="search_results.php">
               <input class="form-control me-2" type="search" 
                ...
                <input type="submit" value="Search" class="btn btn-outline-light" name="search_game_data" style = "padding:10px;">
             </form>
